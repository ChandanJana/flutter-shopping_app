...
/// it tells Dart that all the content that's provided by this package should be
/// bundled into, you could say an object of this name here. So in this case, http,
/// but this could be any name of your choice
...
class _NewItemSate extends State<NewItem> {
  ...
  void _saveItem() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      /// Here we sending/post data (json) to firebase
      final url = Uri.https('flutter-prep-18dfc-default-rtdb.firebaseio.com',
          'shopping_app.json');

      /// await use to wait for return data
      final response = await http.post(
        ...
        /// converting map to json use json.encode
        body: json.encode({
          'name': _enteredName,
